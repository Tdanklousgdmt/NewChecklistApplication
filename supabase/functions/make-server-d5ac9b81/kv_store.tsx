...
/* Table schema:
CREATE TABLE kv_store_d5ac9b81 (
  key TEXT NOT NULL PRIMARY KEY,
  value JSONB NOT NULL
);
*/

// View at https://supabase.com/dashboard/project/hchmskxcjgfscummckcp/database/tables
...
export const set = async (key: string, value: any): Promise<void> => {
  ...
  const { error } = await supabase.from("kv_store_d5ac9b81").upsert({
    key,
    value
  });
  if (error) {
